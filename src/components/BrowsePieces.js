  ...
  return (
    <Router>
      ...
      <div className="container">
         <svg id="arrow" onClick={() => window.location.href = "http://localhost:3001/"} xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="currentColor" class="bi bi-arrow-left" viewBox="0 0 16 16">
