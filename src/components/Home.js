    ...
    <section id="home">
      <MediaQuery minWidth={1270}>
        ...
        <figure onMouseEnter={() => showIt(true)}  className="home-image-1">
          <img onClick={() => window.location.href = "https://www.leibermanglass.com/work"} className="home1" src={shelter}></img>
        </figure>
        
        <figure className="home-image-2">
          <img onClick={() => window.location.href = "https://www.leibermanglass.com/work"} className="home1" src={urchin}></img>
        </figure>
        <figure className="home-image-3">
          <img onClick={() => window.location.href = "https://www.leibermanglass.com/ocotillo"} className="home1" src={blue}></img>
        </figure>
        <figure className="home-image-4">
          <img onClick={() => window.location.href = "https://www.leibermanglass.com/work"} className="home1" src={shelter3}></img>
        </figure>
